...
// function handleSave() {
//     const confirmMessage = 'Are you sure you want to save the changes?';
...
function setBasicFields() {
    ...
    const basicFields = [
        ...
        'clutch_completed', 'date_convention', 'datum_code',
...
function setOtherTagInfo() {
    const container = document.getElementById('otherTagInfoContainer');
    if (!container || !initialData.other_tags_data) return;
...
function setOtherIdentification() {
    const container = document.getElementById('otherIdentificationContainer');
    if (!container || !initialData.recorded_identifications) return;
