...
urlpatterns = [
    ...
    path("api/save-entry-changes/", views.SaveEntryChangesView.as_view(), name="save_entry_changes"),
    ...
    path(
        "curation/observations-management/<int:observation_id>/", views.ObservationManagementView.as_view(), name="observation_management"
    ),
