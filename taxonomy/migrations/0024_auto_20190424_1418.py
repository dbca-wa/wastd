...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0023_auto_20190408_1421'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='hbvfamily',
            name='supra_code',
            field=models.CharField(blank=True, help_text='', max_length=1000, null=True,
                                   verbose_name='HBV Suprafamily Group Code'),
        ),
        migrations.AlterField(
            model_name='hbvgroup',
            name='class_id',
        ...
        migrations.AlterField(
            ...
            name='class_id',
            field=models.CharField(blank=True, help_text='', max_length=100,
                                   null=True, verbose_name='WACensus ClassID'),
        ),
        migrations.AlterField(
            model_name='hbvspecies',
            name='consv_code',
            field=models.CharField(blank=True, help_text='', max_length=100,
                                   null=True, verbose_name='Conservation Code'),
        ),
        migrations.AlterField(
            model_name='hbvspecies',
            name='naturalised',
        ...
        migrations.AlterField(
            model_name='hbvvernacular',
            name='vernacular',
            field=models.CharField(blank=True, help_text='', max_length=1000,
                                   null=True, verbose_name='Vernacular Name'),
        ),
        migrations.AlterField(
            model_name='taxon',
            name='paraphyletic_groups',
            field=models.ManyToManyField(
                blank=True, help_text='All paraphyletic groups this taxon belongs to.', to='taxonomy.HbvSupra', verbose_name='Groups'),
        ),
    ]
