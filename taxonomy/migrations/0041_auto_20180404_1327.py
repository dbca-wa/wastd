...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='community',
            options={'ordering': ['code'], 'verbose_name': 'Community', 'verbose_name_plural': 'Communities'},
        ),
        migrations.AddField(
            model_name='hbvname',
            name='code',
            field=models.CharField(blank=True, help_text='If available, the DBCA six-letter code used in MAX.', max_length=1000, null=True, unique=True, verbose_name='Taxon code'),
        ),
