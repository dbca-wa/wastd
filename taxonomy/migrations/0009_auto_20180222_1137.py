# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-22 03:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0008_auto_20180222_1026'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='hbvsupra',
            name='supra_code',
            field=models.CharField(blank=True, help_text='A short code.', max_length=1000, null=True, unique=True, verbose_name='HBV Suprafamily Group Code'),
        ),
        migrations.AlterField(
            model_name='hbvsupra',
            name='supra_name',
            field=models.CharField(blank=True, help_text="The group's name.", max_length=1000, null=True, verbose_name='HBV Suprafamily Group Name'),
        ),
    ]
