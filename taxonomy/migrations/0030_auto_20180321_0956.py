# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-21 01:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0029_auto_20180320_2049'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='taxon',
            name='canonical_name',
            field=models.CharField(blank=True, db_index=True, help_text='The canonical name.', max_length=2000, null=True, verbose_name='Canonical Name'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='taxonomic_name',
            field=models.CharField(blank=True, db_index=True, help_text='The taxonomic name.', max_length=2000, null=True, verbose_name='Taxonomic Name'),
        ),
