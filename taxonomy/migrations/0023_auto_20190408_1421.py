...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='taxon',
            name='supra_group',
            field=models.CharField(blank=True, help_text='A possibly paraphyletic supragroup for convenient subsetting.', max_length=1000, null=True, verbose_name='HBV Suprafamily Group'),
        ),
