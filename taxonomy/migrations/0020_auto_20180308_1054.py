# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-08 02:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0019_auto_20180223_1417'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='hbvgenus',
            options={'ordering': ['kingdom_id', 'family_nid', 'genusid'], 'verbose_name': 'HBV Genus', 'verbose_name_plural': 'HBV Genera'},
        ),
        ...
        migrations.AlterField(
            model_name='hbvsupra',
            name='supra_name',
            field=models.CharField(blank=True, help_text='The group name.', max_length=1000, null=True, verbose_name='HBV Suprafamily Group Name'),
        ),
    ]
