...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='hbvsupra',
            options={'ordering': ['supra_code'], 'verbose_name': 'Paraphyletic Group', 'verbose_name_plural': 'Paraphyletic Groups'},
        ),
        migrations.AddField(
            model_name='taxon',
            name='field_code',
            field=models.CharField(blank=True, db_index=True, help_text='The agreed acronym, often used on paper datasheets.', max_length=2000, null=True, verbose_name='Field collection code'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='paraphyletic_groups',
            field=models.ManyToManyField(blank=True, help_text='All paraphyletic groups this taxon belongs to.', to='taxonomy.HbvSupra', verbose_name='Paraphyletic Groups'),
        ),
        migrations.AlterField(
            model_name='community',
            name='source_id',
            field=models.CharField(default=uuid.UUID('85f01bba-4623-11e9-a86f-ecf4bb19b5fc'), help_text='The ID of the record in the original source, if available.', max_length=1000, verbose_name='Source ID'),
        ),
        migrations.AlterField(
