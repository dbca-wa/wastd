# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-02-22 06:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0011_auto_20180222_1331'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='hbvgenus',
            name='genus',
            field=models.CharField(blank=True, help_text='The Genus name.', max_length=1000, null=True, verbose_name='Genus'),
        ),
        migrations.AlterField(
            model_name='hbvgroup',
            name='class_id',
        ...
        migrations.AlterField(
            ...
            name='ogc_fid',
            field=models.BigIntegerField(blank=True, help_text='The OCG Feature ID of the record, used to identify the record.', null=True, unique=True, verbose_name='GeoServer OGC FeatureID'),
        ),
    ]
