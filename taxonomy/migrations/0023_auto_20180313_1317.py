# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2018-03-13 05:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taxonomy', '0022_auto_20180308_1757'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='taxon',
            name='current',
            field=models.BooleanField(db_index=True, default=False, help_text='Whether the name is current.', verbose_name='Is current'),
        ),
        migrations.AlterField(
            model_name='taxon',
            name='name',
            field=models.CharField(blank=True, db_index=True, help_text='The taxon name.', max_length=1000, null=True, verbose_name='Taxon Name'),
        ),
        migrations.AlterField(
            model_name='taxon',
            name='name_id',
            field=models.BigIntegerField(db_index=True, help_text='WACensus NameID, assigned by WACensus.', unique=True, verbose_name='NameID'),
        ),
        migrations.AlterField(
            model_name='taxon',
            name='publication_status',
            field=models.PositiveSmallIntegerField(choices=[(0, 'Phrase Name'), (1, 'Manuscript Name'), (2, 'Published Name')], db_index=True, default=2, help_text='On what level the name is published.', verbose_name='Publication Status'),
        ),
        migrations.AlterField(
            model_name='taxon',
            name='rank',
            field=models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Domain'), (10, 'Kingdom'), (20, 'Subkingdom'), (30, 'Division'), (40, 'Subdivision'), (50, 'Class'), (60, 'Subclass'), (70, 'Order'), (80, 'Suborder'), (90, 'Family'), (100, 'Subfamily'), (110, 'Tribe'), (120, 'Subtribe'), (130, 'Genus'), (140, 'Subgenus'), (150, 'Section'), (160, 'Subsection'), (170, 'Series'), (180, 'Subseries'), (190, 'Species'), (200, 'Subspecies'), (210, 'Variety'), (220, 'Subvariety'), (230, 'Forma'), (240, 'Subforma')], db_index=True, help_text='The taxonomic rank of the taxon.', null=True, verbose_name='Taxonomic Rank'),
        ),
    ]
