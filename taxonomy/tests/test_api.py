...
class HbvAPITests(TestCase):
    ...
    def test_get_list_endpoints(self):
        for i in ['name', 'supra', 'group', 'family', 'genus', 'species', 'vernacular', 'xref', 'parent']:
            url = reverse('api:hbv{}-list'.format(i))
    ...
    def test_get_detail_endpoints(self):
        url = reverse('api:hbvname-detail', kwargs={'pk': self.hbvname.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvsupra-detail', kwargs={'pk': self.hbvsupra.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvgroup-detail', kwargs={'pk': self.hbvgroup.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvfamily-detail', kwargs={'pk': self.hbvfamily.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvgenus-detail', kwargs={'pk': self.hbvgenus.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvspecies-detail', kwargs={'pk': self.hbvspecies.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvvernacular-detail', kwargs={'pk': self.hbvvernacular.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvxref-detail', kwargs={'pk': self.hbvxref.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:hbvparent-detail', kwargs={'pk': self.hbvparent.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:taxon_full-detail', kwargs={'pk': self.taxon.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:taxon_fast-detail', kwargs={'pk': self.taxon.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:vernacular-detail', kwargs={'pk': self.vernacular.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:crossreference-detail', kwargs={'pk': self.crossreference.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
        url = reverse('api:community-detail', kwargs={'pk': self.community.pk})
        resp = self.client.get(url, {'format': 'json'})
        self.assertEqual(resp.status_code, 200)
