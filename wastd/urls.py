...
urlpatterns = (
    [
        ...
        path(
            "encounters/",
            wastd_views.EncounterTableView.as_view(),
            name="encounter_list",
        ),
        ...
        path(
            "tasks/resave-surveys/",
            wastd_views.resave_surveys_view,
            name="resave-surveys",
        ),
        path(
            "tasks/reconstruct-surveys/",
            wastd_views.reconstruct_surveys_view,
            name="reconstruct-surveys",
        ),
        path(
