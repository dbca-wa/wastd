...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'wastd', 'templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'debug': DEBUG,
            'context_processors': [
...
LOCAL_USERGROUPS = ["data viewer", "data curator", "data custodian", "data entry", "api"]
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'wastd-noreply@dbca.wa.gov.au')
