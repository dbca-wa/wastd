...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FlipperTagObservation',
            fields=[
                ('observation_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='observations.Observation')),
                ('side', models.CharField(choices=[('L', 'Left'), ('R', 'Right')], default='L', help_text='Is the tag on the left or right front flipper?', max_length=300, verbose_name='Tag side')),
                ('position', models.CharField(choices=[('1', 'Flipper scale 1 (1st from body)'), ('2', 'Flipper scale 2 (2nd from body)'), ('3', 'Flipper scale 3 (3rd from body)')], default='1', help_text='Counting from inside, to which flipper scale is the tag attached?', max_length=300, verbose_name='Tag position')),
