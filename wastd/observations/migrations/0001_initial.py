    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('unknown', 'Unknown Sex')], default='unknown', help_text="The animal's sex.", max_length=300, verbose_name='Sex')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('see_photo', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', help_text='More relevant detail in attached photos', max_length=300, verbose_name='See attached photos')),
