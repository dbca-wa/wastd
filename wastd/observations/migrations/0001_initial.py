# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-07-31 03:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('flipper-tag', 'Flipper Tag'), ('pit-tag', 'PIT Tag'), ('satellite-tag', 'Satellite Tag'), ('physical-sample', 'Physical Sample'), ('genetic-fingerprint', 'Genetic Fingerprint'), ('whisker-id', 'Whisker ID'), ('other', 'Other')], default='flipper-tag', help_text='The Tag type.', max_length=300, verbose_name='Tag type')),
                ('status', models.CharField(choices=[('ordered', 'Ordered from manufacturer'), ('produced', 'Produced by manufacturer'), ('delivered', 'Delivered to HQ'), ('allocated', 'Allocated to field team'), ('attached', 'Attached to an animal'), ('recaptured', 'Re-sighted as attached to animal'), ('detached', 'Taken off an animal'), ('found', 'Found detached'), ('returned', 'Returned to HQ'), ('decommissioned', 'Decommissioned from active tag pool'), ('destroyed', 'Destroyed'), ('observed', 'Observed in any other context, see comments')], default='recaptured', help_text='The status this tag was seen in, or brought into.', max_length=300, verbose_name='Tag status')),
        ...
        migrations.AddField(
            ...
            name='observation',
            field=models.ForeignKey(blank=True, help_text='During which Observation was this tag encountered?', null=True, on_delete=django.db.models.deletion.CASCADE, to='observations.Observation', verbose_name='Observation'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tail_length_mm', models.PositiveIntegerField(blank=True, help_text='The Tail Length, measured from carapace in millimetres.', null=True, verbose_name='c (mm)')),
