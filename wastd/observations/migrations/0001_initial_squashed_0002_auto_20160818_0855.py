# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-18 00:58
...
class Migration(migrations.Migration):
    ...
    replaces = [('observations', '0001_initial'), ('observations', '0002_auto_20160818_0855')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('damage_injury', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Obvious damage or injuries')),
                ('scanned_for_pit_tags', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Scanned for PIT tags')),
                ('missing_limbs', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Missing limbs')),
                ('barnacles', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Barnacles')),
                ('algal_growth', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Algal growth on carapace')),
                ('tagging_scars', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Tagging scars')),
                ('propeller_damage', models.CharField(choices=[('na', 'Not observed'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', max_length=300, verbose_name='Propeller strike damage')),
