# -*- coding: utf-8 -*-
# Generated by Django 1.9.10 on 2016-09-30 08:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('observations', '0023_auto_20160930_1617'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='turtlenestencounter',
            name='disturbance',
            field=models.CharField(choices=[('na', 'NA'), ('absent', 'Confirmed absent'), ('present', 'Confirmed present')], default='na', help_text='Is there evidence of predation or other disturbance?', max_length=300, verbose_name='Evidence of predation or disturbance'),
        ),
