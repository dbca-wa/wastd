# Generated by Django 3.2.19 on 2023-07-03 06:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tail_pokes', models.CharField(blank=True, choices=[('absent', 'Absent'), ('occasional', 'Occasional'), ('regular', 'Regular'), ('na', 'NA')], help_text='Are regular dips in the middle of the track present?', max_length=300, null=True)),
            ],
            options={
                'abstract': False,
