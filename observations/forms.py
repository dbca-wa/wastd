...
from .models import Encounter, AnimalEncounter, TagObservation
...
class Formset(LayoutObject):
    ...
    def __init__(
        self, formset_context_name, helper_context_name=None, template=None, label=None
    ):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Fieldset(
                    "Flipper tags",
                    HTML(
                        "<p>The ID of any tag must be unique within the tag type.</p>"
                    ),
                    Formset(
                        "flipper_tags", template="observations/formset_simple.html"
                    ),
                ),
                HTML("<hr>"),
                Div(
