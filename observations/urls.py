...
urlpatterns = [
    ...
    path("surveys/<int:pk>/close_duplicates/", views.SurveyCloseDuplicates.as_view(), name="survey-close-duplicates"),
    path("surveys/<int:pk>/make_production", views.SurveyMakeProduction.as_view(), name="survey-make-production"),
