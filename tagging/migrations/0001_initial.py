# Generated by Django 3.2.18 on 2023-05-05 01:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tissue_type', models.CharField(choices=[('D', 'A-Tract contents'), ('9', 'Biopsy - gen'), ('1', 'Blood'), ('B', 'Brain'), ('E', 'Epibiota'), ('EGGs', 'Eggs'), ('8', 'Fat - depot storage'), ('D2', 'Faecal matter'), ('7', 'Gonad'), ('5', 'Heart'), ('K', 'Keratin - Fnail'), ('6', 'Kidney'), ('4', 'Liver'), ('3', 'Muscle - Pectoral'), ('S', 'Skeletal'), ('2', 'Skin'), ('W', 'Whole animal')], max_length=8)),
